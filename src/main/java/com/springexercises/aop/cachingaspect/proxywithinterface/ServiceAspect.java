...
public class ServiceAspect {
    ...
    @Pointcut("execution(* com.springexercises.aop.cachingaspect.proxywithinterface.Service.*())")
    private void serviceInterfaceMethods() {
    }

    @Pointcut("execution(* com.springexercises.aop.cachingaspect.proxywithinterface.ServiceImpl.*())")
